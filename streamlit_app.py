...
col2.markdown(f"**Ensaymada:** ${ensaymada_cost(ensaymada_scale):.2f}")
col3.markdown(f"**Ube Crinkles:** ${ube_crinkle_cost(ube_crinkle_scale):.2f}")
col4.markdown(f"**Miscellaneous Expenses (gas, packaging, utlities):** ${total_cost *0.20 :.2f}")
col5.markdown(f"**Total Cost Overral:** ${total_cost * 1.20:.2f}")                                        

st.markdown("### Expected Profit")

col1, col2, col3, col4, col5, col6, col7 = st.columns(7)
col1.markdown(f"**Pandesal Half Dozen:** ${pandesal_halfdozen * 6 }")
col2.markdown(f"**Pandesal Dozen:** ${pandesal_dozen * 10}")
col3.markdown(f"**Ensaymada (4):** ${ensaymada_four * 12}")
col4.markdown(f"**Ensaymada Half Dozen:** ${ensaymada_halfdozen * 15}")
col5.markdown(f"**Spanish Bread (4):** ${spanish_bread_four * 10}")
col6.markdown(f"**Spanish Bread Half Dozen:** ${spanish_bread_halfdozen * 12}")
col7.markdown(f"**Total Profit:** ${pandesal_halfdozen *6}")
st.markdown("---")
